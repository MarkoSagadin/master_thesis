...
First, problem has to be studied, it has to be understood what are objectives, what are current solutions and which approach should be used. 
...
\footnotetext{Scientists Weisel and Hubel showed that different cells in primary visual cortex of a cat responded differently to different visual stimuli\cite{cs231n}.
