...
\subsection{ Common machine learning workflow}
...
First problem has to be studied, it has to be understood what are objectives and which approach will be used. 
