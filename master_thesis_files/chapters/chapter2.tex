...
Like these inputs are downsampled by two in height and width dimensions, discarding 75 \% activations.
...
When computing neural networks we can quantize weights, biases and intermediate values outputted by separate neurons. 
