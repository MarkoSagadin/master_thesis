...
\subsection{ Convolutional Neural Networks}\label{cnn_para}
...
\section{ Transfer Learning}\label{transfer_para}
...
\begin{figure}[ht] 
    \centering
    \includegraphics[width=0.75\linewidth]{transfer_learning.png} 
...
\begin{itemize}
    \item \textb{Shorter training time.} Using a pre-trained model with fixed weights and adding few trainable layers on its top greatly lower training time, simply because there are less parameters to train.
