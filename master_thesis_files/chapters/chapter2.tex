...
Algorithms like k-Means and Expectation Maximization, fall into the category of unsupervised learning algorithms.
...
This behaviour is not limited only to CNNs, but to all DNNs.
