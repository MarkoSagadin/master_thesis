In this chapter we will describe the design of convolutional neural network that will be able to process thermal images and predict what object they contain.
