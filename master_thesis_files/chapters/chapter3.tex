...
As we did not had powerful hardware at our disposal, we created an instance of Linux server that came with TensorFlow pre-installed.
...
Image preparation phase is a step by step process that depends how training data is saved, if it has already been split into train, validation and test sets and what kind of normalization needs to be done on it.
