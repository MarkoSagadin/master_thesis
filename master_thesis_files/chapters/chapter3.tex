...
The human class was resampled three times, while both cow and nature/random classes were resampled six times.
...
This is in many use cases sufficient, however in our case, we are also interested in best performing models that have small size. 
...
Edge Impulse also does model optimization automatically.
...
An example project just runs continuously the inference on one image and outputs results over the serial port.
